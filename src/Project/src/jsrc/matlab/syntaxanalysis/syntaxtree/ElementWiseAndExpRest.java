 ...
 * f1 -> RelationalExp()
 */
public class ElementWiseAndExpRest implements Node {
   public NodeToken f0;
   public RelationalExp f1;

   public ElementWiseAndExpRest(NodeToken n0, RelationalExp n1) {
      f0 = n0;
      f1 = n1;
   }

   public ElementWiseAndExpRest(RelationalExp n0) {
      f0 = new NodeToken("&");
      f1 = n0;
   }
