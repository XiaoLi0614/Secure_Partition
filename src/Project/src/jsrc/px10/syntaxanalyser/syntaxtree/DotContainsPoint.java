 ...
 * f6 -> ")"
 */
public class DotContainsPoint implements Node {
   public NodeToken f0;
   public NodeToken f1;
   public NodeToken f2;
   public NodeToken f3;
   ...
   public DotContainsPoint(NodeToken n0, NodeToken n1, NodeToken n2, NodeToken n3, ExpressionList n4, NodeToken n5, NodeToken n6) {
      f0 = n0;
      f1 = n1;
      f2 = n2;
      f3 = n3;
   ...
   public DotContainsPoint(ExpressionList n0) {
      f0 = new NodeToken(".");
      f1 = new NodeToken("contains");
      f2 = new NodeToken("(");
      f3 = new NodeToken("[");
      f4 = n0;
      f5 = new NodeToken("]");
