 ...
 * f4 -> ")"
 */
public class DotOrdinal implements Node {
   public NodeToken f0;
   public NodeToken f1;
   public NodeToken f2;
   ...
   public DotOrdinal(NodeToken n0, NodeToken n1, NodeToken n2, Expression n3, NodeToken n4) {
      f0 = n0;
      f1 = n1;
      f2 = n2;
      f3 = n3;
   ...
   public DotOrdinal(Expression n0) {
      f0 = new NodeToken(".");
