 ...
 * f1 -> "++"
 */
public class PostIncrementExpression implements Node {
   public PrimaryExpression f0;
   public NodeToken f1;

   public PostIncrementExpression(PrimaryExpression n0, NodeToken n1) {
      f0 = n0;
      f1 = n1;
   }

   public PostIncrementExpression(PrimaryExpression n0) {
      f0 = n0;
      f1 = new NodeToken("++");
   }
