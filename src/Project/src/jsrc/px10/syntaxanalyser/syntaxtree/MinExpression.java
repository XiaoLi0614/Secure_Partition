...
public class MinExpression implements Node {
   ...
   public MinExpression(NodeToken n0, NodeToken n1, NodeToken n2, NodeToken n3, Expression n4, NodeToken n5, Expression n6, NodeToken n7) {
      f0 = n0;
      f1 = n1;
      f2 = n2;
      f3 = n3;
   ...
   public MinExpression(Expression n0, Expression n1) {
      f0 = new NodeToken("Math");
      f1 = new NodeToken(".");
      f2 = new NodeToken("min");
      f3 = new NodeToken("(");
      f4 = n0;
      f5 = new NodeToken(",");
      f6 = n1;
