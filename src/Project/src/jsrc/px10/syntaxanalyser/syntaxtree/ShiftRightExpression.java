 ...
 */
public class ShiftRightExpression implements Node {
   public NodeToken f0;
   public AdditiveExpression f1;

   public ShiftRightExpression(NodeToken n0, AdditiveExpression n1) {
      f0 = n0;
      f1 = n1;
   }

   public ShiftRightExpression(AdditiveExpression n0) {
      f0 = new NodeToken(">>");
      f1 = n0;
   }
