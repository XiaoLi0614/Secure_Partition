 ...
 */
public class ShiftRightUnsignedExpression implements Node {
   public NodeToken f0;
   public AdditiveExpression f1;

   public ShiftRightUnsignedExpression(NodeToken n0, AdditiveExpression n1) {
      f0 = n0;
      f1 = n1;
   }

   public ShiftRightUnsignedExpression(AdditiveExpression n0) {
      f0 = new NodeToken(">>>");
      f1 = n0;
   }
