 ...
 */
public class UnaryPlusExpression implements Node {
   public NodeToken f0;
   public PrimaryExpression f1;

   public UnaryPlusExpression(NodeToken n0, PrimaryExpression n1) {
      f0 = n0;
      f1 = n1;
   }

   public UnaryPlusExpression(PrimaryExpression n0) {
      f0 = new NodeToken("+");
      f1 = n0;
   }
