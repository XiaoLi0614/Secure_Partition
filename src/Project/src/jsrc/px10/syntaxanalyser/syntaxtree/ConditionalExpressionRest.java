 ...
 * f3 -> Expression()
 */
public class ConditionalExpressionRest implements Node {
   public NodeToken f0;
   public Expression f1;
   public NodeToken f2;
   public Expression f3;

   public ConditionalExpressionRest(NodeToken n0, Expression n1, NodeToken n2, Expression n3) {
      f0 = n0;
      f1 = n1;
      f2 = n2;
      f3 = n3;
   ...
   public ConditionalExpressionRest(Expression n0, Expression n1) {
      f0 = new NodeToken("?");
      f1 = n0;
      f2 = new NodeToken(":");
      f3 = n1;
