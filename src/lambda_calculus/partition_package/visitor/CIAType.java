...
public class CIAType {
    ...
    public HashSet<HashSet<Integer>> iJoin(HashSet<HashSet<Integer>> i2){
        //HashSet<HashSet<Integer>> copy1 = new HashSet<>(i1.size());
        // first we need to deep copy i1 and the operate on the copy
        //for(HashSet<Integer> ib1: i1){
            //copy1.add((HashSet<Integer>) ib1.clone());
        //}
