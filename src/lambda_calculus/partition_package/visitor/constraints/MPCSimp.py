...
botC = [ True, True, True ]
botI = [[ 2, 4, 4], [ 0, 0, 0], [ 0, 0, 0] ]
botA = [[ 2, 4, 4], [ 0, 0, 0], [ 0, 0, 0] ]
...
u1OH = [ Int('u1OH_%s' % i) for i in range(n) ] 
...
u1readp11botC = u1writep11outputC
u1readp11botI = u1writep11outputI
u1readp11botA = u1writep11outputA
...
u2readp12botC = u1writep12outputC
u2readp12botI = u1writep12outputI
u2readp12botA = u1writep12outputA
...
s.add(u3range1)
u3range2 = [And(0 <= u3OH[i]) for i in range(n)]
s.add(u3range2)
u3range3 = sLe(u3OH, principals)
s.add(u3range3)
#FieldT: u1
s.add(cLeH(u1writep11outputC, u1OH))
s.add(sIntegrity(u1writep11outputI, u1qs, u1OH))
s.add(availabilityP(u1writep11outputA, u1qs, u1OH))
...
s.add(cLeH(u1writep13outputC, u1OH))
s.add(sIntegrity(u1writep13outputI, u1qs, u1OH))
s.add(availabilityP(u1writep13outputA, u1qs, u1OH))
...
s.add(cLeH(u1writep12outputC, u1OH))
s.add(sIntegrity(u1writep12outputI, u1qs, u1OH))
s.add(availabilityP(u1writep12outputA, u1qs, u1OH))
...
s.add(cLeH(u1random2outputC, u1OH))
s.add(sIntegrity(u1random2outputI, u1qs, u1OH))
s.add(availabilityP(u1random2outputA, u1qs, u1OH))
...
s.add(cLeH(u1random1outputC, u1OH))
s.add(sIntegrity(u1random1outputI, u1qs, u1OH))
s.add(availabilityP(u1random1outputA, u1qs, u1OH))
...
s.add(cLeH(u1random3outputC, u1OH))
s.add(sIntegrity(u1random3outputI, u1qs, u1OH))
s.add(availabilityP(u1random3outputA, u1qs, u1OH))
...
s.add(cLeH(u1readp21outputC, u1OH))
s.add(sIntegrity(u1readp21outputI, u1qs, u1OH))
s.add(availabilityP(u1readp21outputA, u1qs, u1OH))
...
s.add(cLeH(u1getSalaryoutputC, u1OH))
s.add(sIntegrity(u1getSalaryoutputI, u1qs, u1OH))
s.add(availabilityP(u1getSalaryoutputA, u1qs, u1OH))
...
s.add(cLeH(u1readp31outputC, u1OH))
s.add(sIntegrity(u1readp31outputI, u1qs, u1OH))
s.add(availabilityP(u1readp31outputA, u1qs, u1OH))
...
s.add(cLeH(u1readp11outputC, u1OH))
s.add(sIntegrity(u1readp11outputI, u1qs, u1OH))
s.add(availabilityP(u1readp11outputA, u1qs, u1OH))
...
s.add(cLeH(u1computeSum1outputC, u1OH))
s.add(sIntegrity(u1computeSum1outputI, u1qs, u1OH))
s.add(availabilityP(u1computeSum1outputA, u1qs, u1OH))
...
#FieldT: u2
s.add(cLeH(u2readp32outputC, u2OH))
s.add(sIntegrity(u2readp32outputI, u2qs, u2OH))
s.add(availabilityP(u2readp32outputA, u2qs, u2OH))
...
s.add(cLeH(u2computeSum2outputC, u2OH))
s.add(sIntegrity(u2computeSum2outputI, u2qs, u2OH))
s.add(availabilityP(u2computeSum2outputA, u2qs, u2OH))
...
s.add(cLeH(u2readp12outputC, u2OH))
s.add(sIntegrity(u2readp12outputI, u2qs, u2OH))
s.add(availabilityP(u2readp12outputA, u2qs, u2OH))
...
s.add(cLeH(u2readp22outputC, u2OH))
s.add(sIntegrity(u2readp22outputI, u2qs, u2OH))
s.add(availabilityP(u2readp22outputA, u2qs, u2OH))
...
#FieldT: u3
s.add(cLeH(u3readp13outputC, u3OH))
s.add(sIntegrity(u3readp13outputI, u3qs, u3OH))
s.add(availabilityP(u3readp13outputA, u3qs, u3OH))
...
s.add(cLeH(u3computeSum3outputC, u3OH))
s.add(sIntegrity(u3computeSum3outputI, u3qs, u3OH))
s.add(availabilityP(u3computeSum3outputA, u3qs, u3OH))
...
s.add(cLeH(u3readp23outputC, u3OH))
s.add(sIntegrity(u3readp23outputI, u3qs, u3OH))
s.add(availabilityP(u3readp23outputA, u3qs, u3OH))
...
s.add(cLeH(u3readp33outputC, u3OH))
s.add(sIntegrity(u3readp33outputI, u3qs, u3OH))
s.add(availabilityP(u3readp33outputA, u3qs, u3OH))
...
print("m11H:", [m[hInfo].as_long() for hInfo in m11H])
print("m10H:", [m[hInfo].as_long() for hInfo in m10H])
print("m13H:", [m[hInfo].as_long() for hInfo in m13H])
print("m12H:", [m[hInfo].as_long() for hInfo in m12H])
print("m15H:", [m[hInfo].as_long() for hInfo in m15H])
print("m14H:", [m[hInfo].as_long() for hInfo in m14H])
print("m17H:", [m[hInfo].as_long() for hInfo in m17H])
print("m16H:", [m[hInfo].as_long() for hInfo in m16H])
print("m18H:", [m[hInfo].as_long() for hInfo in m18H])
...
print("m11Q:", [m[e].as_long() for qs in m11Q for e in qs])
print("m10Q:", [m[e].as_long() for qs in m10Q for e in qs])
print("m13Q:", [m[e].as_long() for qs in m13Q for e in qs])
print("m12Q:", [m[e].as_long() for qs in m12Q for e in qs])
print("m15Q:", [m[e].as_long() for qs in m15Q for e in qs])
print("m14Q:", [m[e].as_long() for qs in m14Q for e in qs])
print("m17Q:", [m[e].as_long() for qs in m17Q for e in qs])
print("m16Q:", [m[e].as_long() for qs in m16Q for e in qs])
print("m18Q:", [m[e].as_long() for qs in m18Q for e in qs])
print("u1qs:", [m[e].as_long() for qs in u1qs for e in qs])
print("u2qs:", [m[e].as_long() for qs in u2qs for e in qs])
print("u3qs:", [m[e].as_long() for qs in u3qs for e in qs])
print("u1qc:", [m[e].as_long() for qs in u1qc for e in qs])
print("u2qc:", [m[e].as_long() for qs in u2qc for e in qs])
print("u3qc:", [m[e].as_long() for qs in u3qc for e in qs])
print("u1OH:", [m[hInfo].as_long() for hInfo in u1OH])
print("u2OH:", [m[hInfo].as_long() for hInfo in u2OH])
print("u3OH:", [m[hInfo].as_long() for hInfo in u3OH])
