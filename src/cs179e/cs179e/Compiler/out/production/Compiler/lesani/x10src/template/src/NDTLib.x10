...
// Beginning of N-D-TLib.x10
    ...
    // logical { ------------------------------------------------------------------------------
    public static def logical(x: NDT): Boolean {
        return (x != 0);
    }

    public static def logical(x: NDTMatrix): BooleanMatrix {
        val n = x.n;
        val m = x.m;
    ...
    // not { ------------------------------------------------------------------------------
    public static def not(x: NDT) : Boolean {
        return !(x != 0);
    }

    public static def not(x: NDTMatrix) : BooleanMatrix {
        val n = x.n;
        val m = x.m;
    ...
    // unary - { ------------------------------------------------------------------------------
    public static def minus(x: NDT): NDT {
        return -x;
    }

    public static def minus(x: NDTMatrix): NDTMatrix {
        val n = x.n;
        val m = x.m;
    ...
    public static def times(a: BooleanMatrix, b: NDTMatrix): NDTMatrix {
        val rowsA = a.n;
        val columnsA = a.m;
        val rowsB = b.n;
        val columnsB = b.m;
        ...
        return new NDTMatrix(array, rowsA, columnsB);
    }
    public static def times(a: NDTMatrix, b: BooleanMatrix): NDTMatrix {
        val rowsA = a.n;
        val columnsA = a.m;
        val rowsB = b.n;
        val columnsB = b.m;
    ...
    public static def divide(a: NDTMatrix, b: BooleanMatrix): DoubleMatrix {
        if (a.m != b.m)
    ...
    public static def divide(a: BooleanMatrix, b: NDTMatrix): DoubleMatrix {
        if (a.m != b.m)
            error("At matrix / op: Mismatch of Operand Dimensions.");
    ...
    public static def power(a: NDT, n: Int): NDT {
        return (Math.pow(a, n) as NDT);
    }

    public static def power(a: NDTMatrix, n: Int): NDTMatrix {
        var b: NDTMatrix = a;
    ...
    public static def sqrt(x: NDTMatrix): DoubleMatrix {
    ...
    public static def norm(a: NDTMatrix): Double {
        val n = a.n;
        val m = a.m;
        if ((n != 1) && (m != 1)) {
//            error("At norm: To be implemented. norm of a non-vector matrix.");
    ...
    public static def norm(mat: NDTMatrix, st: String): Double {
        val n = mat.n;
        val m = mat.m;
    ...
    public static def norm(a: NDTMatrix, c: Int): NDT {
        val n = a.n;
        val m = a.m;
        if (c == 1) {
            var f: NDT = 0;
    ...
    // sort { ---------------------------------------------------------------------------
    private static def sortV(a: NDTMatrix, lo0: Int, hi0: Int) {
    ...
    private static def sortIV(a: NDTMatrix, index: IntMatrix, lo0: Int, hi0: Int) {
    ...
    private static def sortH(a: NDTMatrix, lo0: Int, hi0: Int) {
    ...
    private static def sortIH(a: NDTMatrix, index: IntMatrix, lo0: Int, hi0: Int) {
    ...
    private static def sortDV(a: NDTMatrix, lo0: Int, hi0: Int) {
        var lo: Int = lo0;
        var hi: Int = hi0;
        if (lo >= hi) {
            return;
    ...
    private static def sortDIV(a: NDTMatrix, index: IntMatrix, lo0: Int, hi0: Int) {
        var lo: Int = lo0;
        var hi: Int = hi0;
        if (lo >= hi) {
            return;
...
//        Console.OUT.println(a.transpose());
    ...
    private static def sortDH(a: NDTMatrix, lo0: Int, hi0: Int) {
        var lo: Int = lo0;
        var hi: Int = hi0;
        if (lo >= hi) {
            return;
    ...
    private static def sortDIH(a: NDTMatrix, index: IntMatrix, lo0: Int, hi0: Int) {
    ...
    public static def sort(mat: NDTMatrix): NDTMatrix {
        val a = mat.clone();
        if (a.n == 1)
            sortH(a, 0, a.m - 1);
        else if (mat.m == 1)
...
//            sortM(a);
    ...
    // I for with Index
    public static def sortI(mat: NDTMatrix): Tuple2[NDTMatrix, IntMatrix] {
        val a = mat.clone();
...
//            sortIM(a);
            error("At sort: To be implemented.");
        return new Tuple2[NDTMatrix, IntMatrix](a, index);
    }

    // D for descending
    public static def sortD(mat: NDTMatrix): NDTMatrix {
        val a = mat.clone();
        if (a.n == 1)
//            sortDH(a, 0, a.m-1);
            error("At sort: To be implemented.");
...
//            sortM(a);
    ...
    public static def sortDI(mat: NDTMatrix): Tuple2[NDTMatrix, IntMatrix] {
        val a = mat.clone();
        var index: IntMatrix = null;
        if (a.n == 1) {
...
//            sortDIM(a);
    ...
    private static def printList(list: ArrayList[NDT]): Void {
    ...
    private static def addBefore(list: ArrayList[NDT], index: int, v: NDT): Void {
    ...
    private static def unionInsert(list: ArrayList[NDT], v: NDT): Void {
    ...
    public static def unionV(mat1: NDTMatrix, mat2: NDTMatrix): NDTMatrix {
        val list = new ArrayList[NDT]();
        val n1 = mat1.n;
        val n2 = mat2.n;
        ...
        return new NDTMatrix(array, size, 1);
    }

    public static def unionH(mat1: NDTMatrix, mat2: NDTMatrix): NDTMatrix {
        val list = new ArrayList[NDT]();
        val m1 = mat1.m;
        val m2 = mat2.m;
        ...
        return new NDTMatrix(array, 1, size);
    }
    public static def union(mat1: NDTMatrix, mat2: NDTMatrix): NDTMatrix {
...
//            return mat1.clone();
    ...
    public static def singularValueDecomposition (Arg: NDTMatrix):
    ...
    public static def pinv(mat: NDTMatrix): DoubleMatrix {
        if ((mat.n == 1) || (mat.m == 1))
...
//            error("At pinv: To be implemented. pinv of a non-vector matrix.");
    ...
    public static def pinvVector(mat: NDTMatrix): DoubleMatrix {
        val n = mat.n;
        val m = mat.m;
        //here
        var s: Double = 0;
    ...
    public static def pinvMat(x: NDTMatrix): DoubleMatrix {
      if (x.m > x.n)
...
//        Console.OUT.println(singularValues.region.max(1) + 1);
    ...
    // pinv } --------------------------------------------------------------------------
    // double { --------------------------------------------------------------------------
    public static def double(v: NDT): Double {
        return (v as Double);
    }

    public static def double(mat: NDTMatrix): DoubleMatrix {
        val n = mat.n;
        val m = mat.m;
    ...
    // sum { --------------------------------------------------------------------------
    public static def sum(x: NDTMatrix): NDTMatrix {
        val n = x.n;
        val m = x.m;
        val r = (0..0)*(0..m-1);
        val a = new Array[NDT](
        ...
        return new NDTMatrix(a, 1, m);
    }

    public static def sum(x: NDTMatrix, dim: Int): NDTMatrix {
        if (dim == 1)
            return sum(x);
        if (dim != 2)
        ...
        return new NDTMatrix(a, n, 1);
    }
    // sum } --------------------------------------------------------------------------
    // find { --------------------------------------------------------------------------
    public static def find(x: NDTMatrix): IntMatrix {
        val n = x.n;
        val m = x.m;
    ...
    public static def min(x: NDTMatrix): NDTMatrix {
        val n = x.n;
        val m = x.m;
        val r = (0..0)*(0..m-1);
        val a = new Array[NDT](
