...
public class Solver<Var, T> {

    //private Set<ConstConstraint<Var, T>> constConstraints;
    //private Set<ConstConstraint<Var, T>> constConstraints;
    private Set<Constraint<Var>> constraints;

    public Solver(Set<ConstConstraint<Var, T>> constConstraints, Set<SubsetConstraint<Var>> subsetConstraints) {
    ...
    public Solver(Set<Constraint<Var>> constraints) {
