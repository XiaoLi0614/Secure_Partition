 ...
 * f1 -> ExpressionSeq()
 */
public class ExpressionSeqsRest implements Node {
   public NodeToken f0;
   public ExpressionSeq f1;

   public ExpressionSeqsRest(NodeToken n0, ExpressionSeq n1) {
      f0 = n0;
      f1 = n1;
   }

   public ExpressionSeqsRest(ExpressionSeq n0) {
      f0 = new NodeToken(";");
      f1 = n0;
   }
