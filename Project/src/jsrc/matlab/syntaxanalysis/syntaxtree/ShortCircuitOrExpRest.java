 ...
 */
public class ShortCircuitOrExpRest implements Node {
   public NodeToken f0;
   public ShortCircuitAndExp f1;

   public ShortCircuitOrExpRest(NodeToken n0, ShortCircuitAndExp n1) {
      f0 = n0;
      f1 = n1;
   }

   public ShortCircuitOrExpRest(ShortCircuitAndExp n0) {
      f0 = new NodeToken("||");
      f1 = n0;
   }
