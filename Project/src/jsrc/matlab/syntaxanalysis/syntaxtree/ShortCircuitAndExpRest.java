 ...
 * f1 -> ElementWiseOrExp()
 */
public class ShortCircuitAndExpRest implements Node {
   public NodeToken f0;
   public ElementWiseOrExp f1;

   public ShortCircuitAndExpRest(NodeToken n0, ElementWiseOrExp n1) {
      f0 = n0;
      f1 = n1;
   }

   public ShortCircuitAndExpRest(ElementWiseOrExp n0) {
      f0 = new NodeToken("&&");
      f1 = n0;
   }
