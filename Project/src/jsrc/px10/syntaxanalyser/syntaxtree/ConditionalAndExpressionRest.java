 ...
 */
public class ConditionalAndExpressionRest implements Node {
   public NodeToken f0;
   public InclusiveOrExpression f1;

   public ConditionalAndExpressionRest(NodeToken n0, InclusiveOrExpression n1) {
      f0 = n0;
      f1 = n1;
   }

   public ConditionalAndExpressionRest(InclusiveOrExpression n0) {
      f0 = new NodeToken("&&");
      f1 = n0;
   }
