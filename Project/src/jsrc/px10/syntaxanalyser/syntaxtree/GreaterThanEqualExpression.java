 ...
 * f1 -> ShiftExpression()
 */
public class GreaterThanEqualExpression implements Node {
   public NodeToken f0;
   public ShiftExpression f1;

   public GreaterThanEqualExpression(NodeToken n0, ShiftExpression n1) {
      f0 = n0;
      f1 = n1;
   }

   public GreaterThanEqualExpression(ShiftExpression n0) {
      f0 = new NodeToken(">=");
      f1 = n0;
   }
