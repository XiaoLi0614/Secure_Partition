...
public class LogExpression implements Node {
   ...
   public LogExpression(NodeToken n0, NodeToken n1, NodeToken n2, NodeToken n3, Expression n4, NodeToken n5) {
      f0 = n0;
      f1 = n1;
      f2 = n2;
      f3 = n3;
   ...
   public LogExpression(Expression n0) {
      f0 = new NodeToken("Math");
      f1 = new NodeToken(".");
      f2 = new NodeToken("log");
      f3 = new NodeToken("(");
      f4 = n0;
      f5 = new NodeToken(")");
   }
