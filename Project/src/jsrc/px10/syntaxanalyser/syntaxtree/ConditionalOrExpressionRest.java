 ...
 */
public class ConditionalOrExpressionRest implements Node {
   public NodeToken f0;
   public ConditionalAndExpression f1;

   public ConditionalOrExpressionRest(NodeToken n0, ConditionalAndExpression n1) {
      f0 = n0;
      f1 = n1;
   }

   public ConditionalOrExpressionRest(ConditionalAndExpression n0) {
      f0 = new NodeToken("||");
      f1 = n0;
   }
