package jsrc.x10.ast.tree.expression.op.relational;
 ...
 */
public class GreaterThanEqual extends BinaryOp {

    public GreaterThanEqual(Expression operand1, Expression operand2) {
